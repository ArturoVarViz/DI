...
class MyMainWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        grid_layout.addWidget(nCliente_label, 0, 0)
        grid_layout.addWidget(self.nCliente_line_edit, 0, 1)
        grid_layout.addWidget(nome_label, 0, 2)
        grid_layout.addWidget(self.nome_line_edit, 0, 3)

        # Apellidos
        apelidos_label = QLabel("Apelidos:")
        self.apelidos_line_edit = QLineEdit()
        grid_layout.addWidget(apelidos_label, 1, 0)
        grid_layout.addWidget(self.apelidos_line_edit, 1, 1, 1, 3)  # Ocupa 3 columnas

        # Dirección
        direccion_label = QLabel("Dirección:")
        self.direccion_line_edit = QLineEdit()
        grid_layout.addWidget(direccion_label, 2, 0)
        grid_layout.addWidget(self.direccion_line_edit, 2, 1, 1, 3)  # Ocupa 3 columnas

        # Ciudad y Provincia
        ciudad_label = QLabel("Cidade:")
        self.cidade_line_edit = QLineEdit()
        provincia_label = QLabel("Provincia:")
        self.provincia_line_edit = QLineEdit()

        grid_layout.addWidget(ciudad_label, 3, 0)
        grid_layout.addWidget(self.cidade_line_edit, 3, 1)
        grid_layout.addWidget(provincia_label, 3, 2)
        grid_layout.addWidget(self.provincia_line_edit, 3, 3)
        ...
        grid_layout.addWidget(codigoPostal_label, 4, 0)
        grid_layout.addWidget(self.codigoPostal_line_edit, 4, 1)
        grid_layout.addWidget(telefono_label, 4, 2)
        grid_layout.addWidget(self.telefono_line_edit, 4, 3)
        ...
        # Establecer alineación a la derecha
